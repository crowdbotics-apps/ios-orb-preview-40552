"""
Django settings for ios_orb_preview_40552 project.
...
ROOT_URLCONF = 'ios_orb_preview_40552.urls'
...
WSGI_APPLICATION = 'ios_orb_preview_40552.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ios_orb_preview_40552 API",
    "DESCRIPTION": "API documentation for ios_orb_preview_40552 App",
    "VERSION": "v1",
}
